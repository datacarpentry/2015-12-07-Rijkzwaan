...
We've been talking about 'relative paths'. Where we and files are in 
relationship to where we are already. You can also use 'full paths' to 
refer to given files or directories. 
...
This can be very useful if you're setting things up to run on another computer
or using programs in other directories.

[More information on full versus relative paths](04_the_filesystem_paths.md)
